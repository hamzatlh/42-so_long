...
void	put_images(t_game *game)
{
	...
	game->player.img = mlx_xpm_file_to_image(game->mlx, "./assets/p_right.xpm",
	...
	game->ennemie.img = mlx_xpm_file_to_image(game->mlx, "./assets/ennemie.xpm",
			&game->ennemie.x_img, &game->ennemie.y_img);
}
