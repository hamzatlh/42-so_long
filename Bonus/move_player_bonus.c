...
/*   Updated: 2023/01/02 01:38:47 by htalhaou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_up(t_game *game)
{
	if (game->map.map[game->map.player.x - 1][game->map.player.y] != '1')
	{
		...
		if (game->map.map[game->map.player.x - 1][game->map.player.y] == 'M')
			kill_ennemie(game);
		if (game->count_c == 0)
			game->map.map[game->map.exit.x][game->map.exit.y] = 'e';
...
void	ft_move_left(t_game *game)
{
	...
	{		
		...
		if (game->map.map[game->map.player.x][game->map.player.y - 1] == 'M')
			kill_ennemie(game);
		if (game->count_c == 0)
			game->map.map[game->map.exit.x][game->map.exit.y] = 'e';
